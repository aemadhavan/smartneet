...
export default function TopicDetailPage() {
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="bg-red-50 border border-red-200 text-red-800 rounded-md p-4 text-center">
          ...
          <Link href="/biology/bot" className="mt-4 inline-block bg-red-100 text-red-800 px-4 py-2 rounded hover:bg-red-200">
            Return to Botany
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      {/* Navigation */}
      <div className="mb-8">
        <Link href="/biology/bot" className="text-indigo-600 hover:text-indigo-800 flex items-center text-sm">
          <ArrowLeft size={16} className="mr-1" />
          Back to Botany Topics
        </Link>
      </div>
        ...
        <div className="md:col-span-3">
              ...
              <div className="mt-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <CheckCircle size={20} className="text-emerald-500 mr-2 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link 
                href="/biology/bot/topics/2" 
                className="bg-white p-4 rounded border border-gray-200 hover:shadow-md transition-shadow"
              >
                <h4 className="font-medium text-gray-800">Structural Organization in Plants</h4>
                <p className="text-sm text-gray-500 mt-1">Study of morphology and anatomy of plants</p>
              </Link>
              <Link 
                href="/biology/bot/topics/3" 
                className="bg-white p-4 rounded border border-gray-200 hover:shadow-md transition-shadow"
              >
                <h4 className="font-medium text-gray-800">Cell Structure and Function</h4>
                <p className="text-sm text-gray-500 mt-1">Study of cell organelles and cellular processes</p>
              </Link>
            </div>
          </div>
        </div>
