...
export default function BotanyContent({ initialTopics }: BotanyContentProps) {
  ...
  const practiceLink = useMemo(() => {
    return isPremium ? "/practice?subject=botany" : "/practice?subject=botany&limit=free";
  }, [isPremium]);
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-emerald-50 p-4 rounded-md">
            <p className="text-emerald-600 text-2xl font-bold mb-1">{initialTopics.length}</p>
