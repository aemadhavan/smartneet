  ...
  useEffect(() => {
    const fetchTopicsAndSubtopics = async () => {
      ...
      try {
        ...
        // Find chemistry subject ID (should be 2 based on your schema)
        const chemistrySubjectId = 2; // Chemistry subject ID
        
        // Fetch root-level topics for Chemistry
    ...
    return (
      <div className="container mx-auto py-8 px-4 text-center">
        ...
        <p className="text-gray-600">
          {subscriptionLoading ? "Loading subscription status..." : "Loading chemistry topics..."}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Chemistry</h1>
        ...
        <div className="mt-10 flex justify-center">
          <Link 
            href={isPremium ? "/practice?subject=chemistry" : "/practice?subject=chemistry&limit=free"}
            className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 text-lg font-medium shadow-sm"
          >
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">NEET Chemistry Overview</h2>
        <div className="grid md:grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-blue-50 p-4 rounded-md">
            <p className="text-blue-600 text-2xl font-bold mb-1">{topics.length}</p>
              ...
              <div key={topic.topic_id} className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 relative">
                <div className={`p-6 ${!isTopicAccessible && 'relative'}`}>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {isTopicAccessible ? (
                      <Link 
                        href={`/chemistry/topics/${topic.topic_id}`}
                      ...
                      <Link 
                        href={`/pricing?from=chemistry-topic-${topic.topic_id}`}
