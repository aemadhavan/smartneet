//File: src/app/chemistry/topics/[id]/page.tsx
...
export default function ChemistryTopicDetailPage() {
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="bg-red-50 border border-red-200 text-red-800 rounded-md p-4 text-center">
          ...
          <Link href="/chemistry" className="mt-4 inline-block bg-red-100 text-red-800 px-4 py-2 rounded hover:bg-red-200">
            Return to Chemistry
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      {/* Navigation */}
      <div className="mb-8">
        <Link href="/chemistry" className="text-indigo-600 hover:text-indigo-800 flex items-center text-sm">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 sticky top-4">
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              {Boolean(isPremium) || isFreeTopic ? (
                <Link 
                  href={`/practice?subject=chemistry&topicId=${topic.topic_id}`}
                ...
                <Link 
                  href={`/pricing?from=practice-chemistry-${topic.topic_id}`}
          ...
          {activeSubtopic ? (
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <div className="mt-8 flex justify-end">
                ...
                {Boolean(isPremium) || isFreeTopic ? (
                  <Link
                    href={`/practice?subject=chemistry&topicId=${topic.topic_id}&subtopicId=${activeSubtopic.subtopic_id}`}
              ...
              {allTopics.slice(0, 2).map((relatedTopic) => (
                relatedTopic.topic_id.toString() !== topicId && (
                  <Link 
                    ...
                    href={`/chemistry/topics/${relatedTopic.topic_id}`} 
