...
export default function ChemistryContent({ initialTopics }: ChemistryContentProps) {
  ...
  const practiceLink = useMemo(() => {
    return clientIsPremium ? "/practice?subject=chemistry" : "/practice?subject=chemistry&limit=free";
  }, [clientIsPremium]);
