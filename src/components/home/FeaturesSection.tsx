...
const FeaturesSection = () => {
  return (
    <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style={{ minHeight: '600px' }}>
      {/* Removed whileInView animation to prevent layout shift */}
      ...
      {/* Removed motion animations to eliminate CLS */}
