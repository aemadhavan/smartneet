//File: /src/app/componets/layout/Footer.tsx
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
                ...
                <a href="https://www.x.com/smarterneet" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.youtube.com/@smarterNEET" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/biology" className="text-gray-400 hover:text-white transition-colors">Biology</a></li>
              <li>Physics (Coming soon)<a href="#" className="text-gray-400 hover:text-white transition-colors"></a></li>
              <li>Chemistry (Coming soon)<a href="#" className="text-gray-400 hover:text-white transition-colors"></a></li>
